...
function Address() {
  return (
    <div className="contact py-12 sm:py-24">
      <PageContainer>
        <h2 className="address-title text-blue-950">İLETİŞİM</h2>
        <div className="contact-container  flex flex-col md:flex-row gap-12 md:gap-24">
          <iframe
            className="iframe rounded w-full"
            title="myaddress"
            style={{
              border: "0",
              // borderRadius: ".7rem",
          ...
          {/* <div className="fallow text-blue-950 w-full">
            <p className="address-title">Fallow Us</p>
            <XIcon />
          </div> */}
        </div>
